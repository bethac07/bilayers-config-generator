      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-md text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            placeholder="e.g. input_image_folder"
          />
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-white/70 mb-1">Unique String</label>
          <input
            type="text"
            value={formData.unique_string || ''}
            onChange={(e) => handleChange('unique_string', e.target.value)}
            className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-md text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            placeholder="e.g. mask; leave blank if none"
          />
        </div>
